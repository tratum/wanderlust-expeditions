...
class WeekendViewDesktop extends ViewModelWidget<PlaceViewModel> {
  const WeekendViewDesktop({super.key});
                ...
                children: [
                  Padding(
                    ...
                    child: CustomBreadcrumbs.getCrumbs(
                      context,
                      ['Home', 'Destinations', 'Weekend Destinations'],
                      [
                        () {
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        const Text(
                    weekendHeading1,                          style: TextStyle(
                            fontFamily: 'Afacad',
                        ...
                        horizontalSpaceSmall,
                        const Text(
                          weekendHeading2,                          style: TextStyle(
                            fontFamily: 'Afacad',
                            fontWeight: FontWeight.w900,
                            fontSize: 28,
                            color: Color(0XFFfcf8ef),
                  ...
                  const Padding(
                    ...
                    child: Text(
                      weekendSubHeading,                      style: TextStyle(
                        fontFamily: 'Afacad',
                    ...
                    child: Container(
                      ...
                      child: FutureBuilder(
                          future: FetchFromAPI.destinations(
                              "https://tratum.github.io/wanderlust-expeditions-api/weekendPlaces.json"),
