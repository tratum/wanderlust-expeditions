...
class FoodieViewDesktop extends ViewModelWidget<PlaceViewModel> {
  const FoodieViewDesktop({super.key});
                ...
                children: [
                  Padding(
                    ...
                    child: CustomBreadcrumbs.getCrumbs(
                      context,
                      ['Home', 'Destinations', 'Foodie Destinations'],
                      [
                        () {
                    ...
                    child: Container(
                      ...
                      child: FutureBuilder(
                          future: FetchFromAPI.destinations(
                              "https://tratum.github.io/wanderlust-expeditions-api/foodiePlaces.json"),
