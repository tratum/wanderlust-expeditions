...
class RelaxingViewDesktop extends ViewModelWidget<PlaceViewModel> {
  const RelaxingViewDesktop({super.key});
                ...
                children: [
                  Padding(
                    ...
                    child: CustomBreadcrumbs.getCrumbs(
                      context,
                      ['Home', 'Destinations', 'Relaxing Destinations'],
                      [
                        () {
                        ...
                        () {
                          return locator<RouterService>().navigateToRelaxView();
                        }
                      ],
                    ...
                    child: Container(
                      ...
                      child: FutureBuilder(
                          future: FetchFromAPI.destinations(
                              "https://tratum.github.io/wanderlust-expeditions-api/relaxingPlaces.json"),
