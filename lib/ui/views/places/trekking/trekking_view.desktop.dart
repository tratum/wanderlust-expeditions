...
class TrekkingViewDesktop extends ViewModelWidget<PlaceViewModel> {
  const TrekkingViewDesktop({super.key});
                ...
                children: [
                  Padding(
                    ...
                    child: CustomBreadcrumbs.getCrumbs(
                      context,
                      ['Home', 'Destinations', 'Trekking Destinations'],
                      [
                        () {
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        const Text(
                    trekkingHeading1,                          style: TextStyle(
                            fontFamily: 'Afacad',
                        ...
                        horizontalSpaceSmall,
                        const Text(
                          trekkingHeading2,                          style: TextStyle(
                            fontFamily: 'Afacad',
                            fontWeight: FontWeight.w900,
                            fontSize: 28,
                            color: Color(0XFFfcf8ef),
                  ...
                  const Padding(
                    ...
                    child: Text(
                      trekkingSubHeading,                      style: TextStyle(
                        fontFamily: 'Afacad',
                    ...
                    child: Container(
                      ...
                      child: FutureBuilder(
                          future: FetchFromAPI.destinations(
                              "https://tratum.github.io/wanderlust-expeditions-api/trekkingPlaces.json"),
