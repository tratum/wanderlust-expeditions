...
class MountainViewDesktop extends ViewModelWidget<PlaceViewModel> {
  const MountainViewDesktop({super.key});
                ...
                children: [
                  Padding(
                    ...
                    child: CustomBreadcrumbs.getCrumbs(
                      context,
                      ['Home', 'Destinations', 'Hill Destinations'],
                      [
                        () {
                  ...
                  const Padding(
                    ...
                    child: Text(
                      hillSubHeading,                      style: TextStyle(
                        fontFamily: 'Afacad',
                    ...
                    child: Container(
                      ...
                      child: FutureBuilder(
                          future: FetchFromAPI.destinations(
                              "https://tratum.github.io/wanderlust-expeditions-api/hillStation.json"),
