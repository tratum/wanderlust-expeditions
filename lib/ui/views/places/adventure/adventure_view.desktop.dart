...
import 'package:wanderlust_expeditions/ui/common/app_strings.dart';
...
class AdventureViewDesktop extends ViewModelWidget<PlaceViewModel> {
  const AdventureViewDesktop({super.key});
                ...
                children: [
                  Padding(
                    ...
                    child: CustomBreadcrumbs.getCrumbs(
                      context,
                      ['Home', 'Destinations', 'Adventure Destinations'],
                      [
                        () {
                    ...
                    child: Container(
                      ...
                      child: FutureBuilder(
                          future: FetchFromAPI.destinations(
                              "https://tratum.github.io/wanderlust-expeditions-api/adventurePlaces.json"),
