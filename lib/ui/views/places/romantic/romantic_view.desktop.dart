...
class RomanticViewDesktop extends ViewModelWidget<PlaceViewModel> {
  const RomanticViewDesktop({super.key});
                ...
                children: [
                  Padding(
                    ...
                    child: CustomBreadcrumbs.getCrumbs(
                      context,
                      ['Home', 'Destinations', 'Romantic Destinations'],
                      [
                        () {
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        const Text(
                          romanticHeading1,                          style: TextStyle(
                            fontFamily: 'Afacad',
                        ...
                        horizontalSpaceSmall,
                        const Text(
                          romanticHeading2,                          style: TextStyle(
                            fontFamily: 'Afacad',
                            fontWeight: FontWeight.w900,
                            fontSize: 28,
                            color: Color(0XFFfcf8ef),
                  ...
                  const Padding(
                    ...
                    child: Text(
                      romanticSubHeading,                      style: TextStyle(
                        fontFamily: 'Afacad',
                    ...
                    child: Container(
                      ...
                      child: FutureBuilder(
                          future: FetchFromAPI.destinations(
                              "https://tratum.github.io/wanderlust-expeditions-api/romanticPlaces.json"),
